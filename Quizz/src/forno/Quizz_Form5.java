 ...
 * @author Aluno
 */
public class Quizz_Form5 extends javax.swing.JFrame {
...
if(contNextQuestionActionPerformed == getTotalUser+1){
    ...
    txtNumQuestao.setText(" ");
                ...
                new TelaFinal(totmark).setVisible(true);
...
//
//            txtNumQuestao.setText(q.toStringId());
//                Lbl_Question.setText(q.getPergunta());
//                jRadioButton1_.setText(q.getOpcao1());
//                jRadioButton2_.setText(q.getOpcao2());
//                jRadioButton3_.setText(q.getOpcao3());
//                jRadioButton4_.setText(q.getOpcao4());
//                answer = q.getOpcaocorreta();
//
//        }
       
       //Iterator itr = qdao.read().iterator();
    ...
    QuestoesDAO qdao = new QuestoesDAO();
    Iterator<Questoes> itr = qdao.read().iterator();
    ...
    public void TestQdao(){
            Collections.shuffle(qdao.read());
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Quizz_Form5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Quizz_Form5().setVisible(true);
            }
        });
    }
